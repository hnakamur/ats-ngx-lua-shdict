...
#define TSFatal(...) ngx_log_error(NGX_LOG_CRIT, ngx_cycle->log, 0, __VA_ARGS__)

#define TSError(...) ngx_log_error(NGX_LOG_ERR, ngx_cycle->log, 0, __VA_ARGS__)
...
#define TSAlert(args...) ngx_log_error(NGX_LOG_ALERT, ngx_cycle->log, 0, args)

#define TSFatal(args...) ngx_log_error(NGX_LOG_CRIT, ngx_cycle->log, 0, args)

#define TSError(args...) ngx_log_error(NGX_LOG_ERR, ngx_cycle->log, 0, args)

#define TSWarning(args...) ngx_log_error(NGX_LOG_WARN, ngx_cycle->log, 0, args)

#define TSNote(args...) ngx_log_error(NGX_LOG_NOTICE, ngx_cycle->log, 0, args)

#define TSStatus(args...) ngx_log_error(NGX_LOG_INFO, ngx_cycle->log, 0, args)
