...
#define mps_queue_head(pool, h) mps_queue((pool), (h)->next)

#define mps_queue_last(pool, h) mps_queue((pool), (h)->prev)

#define mps_queue_sentinel(pool, h) (h)

#define mps_queue_next(pool, q) mps_queue((pool), (q)->next)

#define mps_queue_prev(pool, q) mps_queue((pool), (q)->prev)
